                        ...
                        <form action="" method="post">
                            ...
                            <!-- UNIDAD DE ORIGEN ELEGIDA POR USUARIO-->
                                <select name='from_unit' class="conversor__data-cantidades" value='from_unit' required oninvalid="this.setCustomValidity('Por favor seleccione la unidad de origen')" oninput="setCustomValidity('')" >
                                    ...
                                    <option value="Decimetro Cubico">Decimetro Cubico</option>
                                    <option value="Metro Cubico">Metro Cubico</option>
                                    <option value="Decametro Cubico">Decametro Cubico</option>
                                    <option value="Hectometro Cubico">Hectometro Cubico</option>
                                    <option value="Kilometro Cubico">Kilometro Cubico</option>
                                </select>
                            </div>
